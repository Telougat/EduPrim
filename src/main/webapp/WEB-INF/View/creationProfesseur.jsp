            ...
            <jsp:body>
                <form action="" class="mb-32">
                    ...
                    <div class="mt-6">
                        ...
                        <input class="w-full border-2 border-gris rounded-lg p-2" type="text" id="motDePasse" name="motDePasse"/>
                    </div>
                    <div class="mt-6">
                        <p class="text-gris font-bold text-xl mb-1">Confirmer le mot de passe</p>
                        <input class="w-full border-2 border-gris rounded-lg p-2" type="text" id="confirmMotDePasse"/>
                    </div>
