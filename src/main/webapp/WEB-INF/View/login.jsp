            ...
            <div class="w-4/5 lg:w-1/2 lg:p-40 rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                <form method="post">
                    ...
                    <div class="mb-20 lg:mb-6">
                        ...
                        <input class="font_tahoma shadow appearance-none text-gris focus:text-violet border-solid border border-gris text-5xl lg:text-xl bordures-arrondies w-full py-4 px-4 text-grey-darker" id="email" name="email" type="text" value="fpichon@cesi.fr" required>
                    </div>
                    <div class="mb-20 lg:mb-6">
                        <label class="font_tahoma block text-grey-darker text-5xl lg:text-xl font-bold mb-1 text-gris" for="mdp">
                            Mot de passe
                        </label>
                        <input class="font_tahoma shadow appearance-none text-gris focus:text-violet border border-gris text-5xl lg:text-xl bordures-arrondies w-full py-4 px-4 text-grey-darker mb-3" id="mdp" name="mdp" type="password" placeholder="" value="123" required>
                    </div>
                    <div class="flex items-center justify-between">
                        <button class="font_tahoma bg-violet hover:bg-blue-dark text-blanc text-5xl lg:text-xl font-bold p-5 bordures-arrondies w-full" type="submit">
                            Se connecter
                        </button>
                    </div>
