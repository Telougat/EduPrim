                    ...
                    <div class="w-full md:w-1/2 bg-red-200 p-1 h-full">
                        <div class="flex flex-wrap w-full">
                            <div class="md:w-1/2 w-full">
                                ...
                                <input class=" border border-gris rounded-lg p-2 focus:text-violet focus:border-rose focus:shadow-2xl shadow-lg w-5/6 border-opacity-50" id="name"  placeholder="${student.getNom()}">
                            </div>
                            <div class="w-1/2">
                                <p class="font-semibold text-violet mb-1">Prénom :</p>
                                <input class="border border-gris rounded-lg p-2 focus:text-violet focus:border-rose focus:shadow-2xl shadow-lg w-5/6 border-opacity-50" id="firstName"  placeholder="${student.getPrenom()}">
                            </div>
                        </div>
                        <br>
                        <div class="my-3">
                            <p class="font-semibold text-violet mb-1">Date de naissance :</p>
                            <input class="border border-gris rounded-lg p-2 focus:text-violet focus:border-rose focus:shadow-2xl shadow-lg border-opacity-50" id="birthDate"  placeholder="${student.getDateDeNaissance()}">
                        </div>
                        <div class="my-3">
                            <p class="font-semibold text-violet mb-1">Adresse du responsable :</p>
                            <input class="border border-gris rounded-lg p-2 focus:text-violet focus:border-rose focus:shadow-2xl shadow-lg border-opacity-50" id="address"  placeholder="${student.getAdresse()}">
                        </div>
                        <div class="my-3">
                            <p class="font-semibold text-violet mb-1">Adresse mail du responsable :</p>
                            <input class="border border-gris rounded-lg p-2 focus:text-violet focus:border-rose focus:shadow-2xl shadow-lg border-opacity-50" id="mail"  placeholder="${student.getMail()}">
                        </div>
                        <div class="my-3">
                            <p class="font-semibold text-violet mb-1">Téléphone du responsable :</p>
                            <input class="border border-gris rounded-lg p-2 focus:text-violet focus:border-rose focus:shadow-2xl shadow-lg border-opacity-50" id="phone"  placeholder="${student.getTelephone()}">
                        </div>
                    </div>
