...
<p:pageWithoutLogo>
    <jsp:body>
        <p:prefabody>
            <jsp:body>
                <form action="">
                    <h3 class="text-gris font-bold text-3xl text-center">Suppression du professeur : #PROFESSEUR#</h3>
                    <p class="text-2xl font-bold text-rose text-center">Souhaitez-vous vraiment<br>supprimer le compte de ce professeur ?</p>
