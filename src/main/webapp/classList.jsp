...
<body>
    ...
    <div class="flex bg-blanc shadow-2xl rounded-lg mx-4 md:mx-auto my-56 w-3/5 border border-gris border-1 pr-4 pl-4">
        <div class="flex items-start px-4 py-6 w-full ml-2">
            ...
            <div>Corporis eaque expedita fuga hic itaque labore laudantium praesentium quaerat, velit voluptatem.
                Accusantium ad aliquam debitis, eaque eum itaque iusto mollitia numquam officiis perspiciatis porro
                quasi quisquam quos repudiandae voluptates!
            </div>
            <div>Accusantium excepturi possimus quasi voluptas? Aliquid asperiores dolorum ducimus esse et explicabo,
                facere id illum laborum natus nemo odio officia possimus reiciendis reprehenderit, repudiandae saepe
                sequi ut velit veritatis! Obcaecati.
            </div>
        </div>
    </div>
</body>
